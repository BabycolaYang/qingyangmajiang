cc.Class({
    ...
    initView:function(){
        ...
        this._gamecount.string = "第" + cc.vv.gameNetMgr.numOfQuans + "圈/" + cc.vv.gameNetMgr.maxNumOfGames + "圈";
    ...
    initEventHandlers:function(){
        ...
        this.node.on('game_num',function(data){
            self._gamecount.string = "第" + cc.vv.gameNetMgr.numOfQuans + "圈/" + cc.vv.gameNetMgr.maxNumOfGames + "圈";
        });

        this.node.on('game_quan',function(data){
            self._gamecount.string = "第" + cc.vv.gameNetMgr.numOfQuans + "圈/" + cc.vv.gameNetMgr.maxNumOfGames + "圈";
        });
